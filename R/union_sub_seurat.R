...
load(load.data1)
sub.obj1=seurat.obj
#clust1=Idents(seurat.obj)
#sub.obj1=subset(seurat.obj,cells=names(Idents(seurat.obj)[Idents(seurat.obj) %in% clust1]))

load(load.data2)
sub.obj2=seurat.obj
#clust2=Idents(seurat.obj)
#sub.obj2=subset(seurat.obj,cells=names(Idents(seurat.obj)[Idents(seurat.obj) %in% clust2]))

seurat.obj=merge(x=sub.obj1,y=sub.obj2)
ncol(sub.obj1);ncol(sub.obj2);ncol(seurat.obj)
...
seurat.obj <- FindClusters(seurat.obj,resolution = resolution,random.seed=123) # change resultion
